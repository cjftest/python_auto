...
class JdCategorySpider(scrapy.Spider):
    ...
    def get_category_name_url(self,category_info):
        ...
        :return:分类的名称和url
        分析数据格式（三类数据格式）：
        1）book.jd.com/library/science.html|科学技术||0
        2）1713-3287|计算机与互联网||0
            2-1  https://channel.jd.com/{}.html
        3)4938-12420-13755|团队建设||0
            3-1 https://list.jd.com/list.html?cat=4938,12420,13755  变为 https://list.jd.com/list.html?cat={}
            把 - 替换为 , 然后填充到占位的地方
        """
